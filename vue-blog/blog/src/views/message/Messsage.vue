...
export default {
  ...
  methods: {
    addToList() {
      ...
      const userFace = this.$store.state.userface
        ? this.$store.state.userface
...
.message-banner {
  ...
  right: 0;
  height: 100vh;
  background: url("http://qtysfkbdh.hn-bkt.clouddn.com/6cc98cfe-eb13-4b93-aa1d-fe420b55eff3") center center /
    cover no-repeat;
