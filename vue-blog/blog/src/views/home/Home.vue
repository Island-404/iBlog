        ...
        >
          ...
          <div class="article-wrapper">
            ...
            <div class="article-info">
              ...
              <span class="separator">|</span>
              <!-- 文章分类 -->
              <router-link :to="'/categories/' + item.cid">
        ...
        <div class="blog-wrapper">
          <v-card class="animated zoomIn blog-card mt-5">
            <div class="author-wrapper">
              <!-- 博主头像 -->
              <v-avatar size="110">
                <img class="author-avatar" :src="blogInfo.userface" />
              </v-avatar>
            ...
            <div class="card-info-social">
              <a
                target="_blank"
                href="https://weibo.com/5443284098/profile?topnav=1&wvr=6&is_all=1"
                class="iconfont iconweibo"
              />
              <a
                target="_blank"
                href="https://github.com/Island-404"
                class="ml-5 mr-5 iconfont icongithub"
              />
              <a
                target="_blank"
                href="https://gitee.com/is_land"
          ...
          <v-card class="blog-card animated zoomIn mt-5 big">
            <div class="web-info-title">
              <v-icon size="18" style="color: #ffb300">mdi-bell</v-icon>
              公告
            </div>
          ...
          <v-card class="blog-card animated zoomIn mt-5 big">
            ...
            <div v-for="(a,index) in blogInfo.articleRankDTOList"  
                  :key="a.id" 
                  class="me-category-item"
                  style="font-size:0.875rem">
                <router-link :to="'/articles/' + a.id">
                  {{index+1}}. {{a.articleTitle}}
                </router-link>
...
export default {
  ...
  methods: {
    ...
    runTime() {
      var timeold =
        new Date().getTime() - new Date("May 5,2021").getTime();
    ...
    getBlogInfo() {
      this.axios.get("/api/info").then(({ data }) => {
...
.home-banner {
  ...
  right: 0;
  height: 100vh;
  background: url("http://qtysfkbdh.hn-bkt.clouddn.com/6764f43e-9280-4ccb-bfda-8bcc3dc3313a") center
