      ...
      <div class="article-info-container">
        ...
        <div class="article-info">
          ...
          <div class="third-line">
            ...
            <!-- 阅读量 -->
            <span>
              <i class="iconfont iconliulan" /> 阅读量: {{ article.pageView }}
            </span>
            <span class="separator">|</span>
            <!-- 评论量 -->
            <span>
      ...
      <v-col md="9" cols="12">
        <v-card class="article-wrapper">
          ...
          <div class="aritcle-copyright">
            <div>
              <span>文章作者：</span>
              <a href="http://www.talkxj.com" target="_blank"> {{article.nickname}}</a>
            </div>
            <div>
              <span>文章链接：</span>
...
export default {
  ...
  methods: {
    ...
    like() {
      ...
      this.axios.post("/api/articles/like", param, {
        headers:{
    ...
    markdownToHtml(article) {
      ...
      // 将markdown替换为html标签
      article.mdContent = md.render(article.mdContent);
