  ...
  <div>
    ...
    <div class="comment-input-wrapper">
      <div style="display:flex">
        <v-avatar size="40">
          <img
            v-if="this.$store.state.userface"
            :src="this.$store.state.userface"
          />
          <img
            v-else
      ...
      >
        ...
        <div class="comment-meta">
          ...
          <div class="comment-user">
            ...
            <span class="blogger-tag" v-if="item.userId == 7">博主</span>
          </div>
          <!-- 信息 -->
          ...
          >
            ...
            <v-avatar size="36" class="comment-avatar">
              <img :src="reply.userface" />
            </v-avatar>
            <div class="reply-meta">
              <!-- 用户名 -->
              <div class="comment-user">
                  {{ reply.nickname }}
                <span class="blogger-tag" v-if="reply.userId == 7">博主</span>
              </div>
              <!-- 信息 -->
              <div class="comment-info">
                <!-- 发表时间 -->
